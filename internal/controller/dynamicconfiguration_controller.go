...
//+kubebuilder:rbac:groups=nacos.io.nacos.io,resources=dynamicconfigurations,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=nacos.io.nacos.io,resources=dynamicconfigurations/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=nacos.io.nacos.io,resources=dynamicconfigurations/finalizers,verbs=update
